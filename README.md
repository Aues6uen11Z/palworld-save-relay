...
Go 1.22+ · Wails v3 (alpha) · React 18 + TypeScript + Vite + Tailwind · 七牛云 Kodo · `go-oodle`（Oodle，CGO 调用 oo2core DLL，需 mingw gcc）
...
需要 Go 1.22+、Node.js、[Wails v3 CLI](https://wails.io)、mingw-w64 gcc（go-oodle 依赖 CGO）：
